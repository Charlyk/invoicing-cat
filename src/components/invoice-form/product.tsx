...
import {removeItem, selectClient, updateItem} from "@/lib/features/ivoicing/invoicingSlice";
...
export const Product = (props: ProductProps) => {
  ...
  const currency = currencies.find((item) => item.code === client?.currency) ?? currencies[0];
